      ...
      <div className="flex flex-col items-center w-full mt-3">
        <div className="display-flex justify-start w-full mb-6 p-2">
          <a target="_blank" rel="noreferrer">
            <p className="text-white text-base">From: {shortenAddress(transaction.addressFrom)}</p>
          </a>
          <a  target="_blank" rel="noreferrer">
            <p className="text-white text-base">To: {shortenAddress(transaction.addressTo)}</p>
          </a>
          <p className="text-white text-base">Amount: {transaction.amount} ETH</p>
          { transaction.message && (
            <>
              <br />
              <p className="text-white text-base">Message: {transaction.message}</p>
            </>
          )}
        </div>
        <img
